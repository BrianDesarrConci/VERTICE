...
function defaultContent_() {
  ...
  return {
    ...
    heroCtaText: 'Comprar ahora', heroCtaLink: '/catalogo', heroSecondaryText: 'Ver colecciones',
    heroAlign: 'left', heroOverlay: 55,
    announcement: '🚚 Envío GRATIS en compras sobre $200.000 · 🎁 Usa BIENVENIDA y llévate 10% OFF · Nueva colección disponible',
    showAnnouncement: true, showSearch: true,
    showCategories: true, categoriesTitle: 'Compra por categoría',
    showTrending: true, trendingTitle: 'Tendencia ahora',
    showNew: true, newTitle: 'Recién llegado',
    showReviewsHome: true, showNewsletter: true, newsletterTitle: 'Únete a la comunidad VÉRTICE', showPromo: true,
    ...
    radius: 'soft', buttonStyle: 'pill',
    showBlobs: true, blobIntensity: 55, seasonalEffect: 'none', seasonBadge: '',
    ...
    instagramUrl: 'https://instagram.com/vertice_impacto', facebookUrl: '', tiktokUrl: '',
    whatsappNumber: '', showWhatsappFloat: false,
    contactEmail: 'hola@vertice.co', contactPhone: '+57 300 000 0000', contactAddress: 'Medellín, Colombia', contactHours: 'Lun–Sáb 9:00–18:00',
  };
}
